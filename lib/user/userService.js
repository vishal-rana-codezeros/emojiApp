...
function syncContacts(req, res) {
	...
	var newData = data.contacts.filter(function (result) {
		return result.contactNumber
	})
	console.log("inottttttt", newData)
	// const data1 = data.contacts.map(newdata => newdata.contactNumber);
	// emoji_schema.find({ "contactNumber": data1[2] }).then(async (result) => {
	// 	if (result) {
	// 		console.log("Number Exits", result)
	// 	}
	// 	else if (result == NULL) {
	// 		console.log("Not Exits")
	// 	}
	// }).catch(err => { return { status: false, result: {} } })

	// console.log(">>>>>>>>>>>>>>>>>>>>>>.", data1)

	// var emptyarray = []

	// var emptyarray = data.map(function (newdata) {
	// 	return newdata.contactNumber
	// });
	...
	// 			as: "item",
	// 			cond: {
	// 				 $eq:["$$item.contactNumber",'+91773814194' ]
	// 			}
	// 		}
	// 	}
	// }]
	// console.log(data)
	// return emoji_schema.aggregate(data).then((result) => {
	// 	// let result1 = req.body
	// 	console.log("into function contactNumber:-", result)

	// 	// console.log("into function", result)
