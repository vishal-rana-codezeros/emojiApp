const messages = {
  ...
  gentoknfailure: 'An Error Occurred while Creating Token',
  ...
  numNotExits: "Number do not exists",
  contactGet: "Contacts Get Successfully",
  numExits: "Phone number already exist",
  emailExits: "Email id already exist",
  ImageUploadFailure: "Please Choose Image",
  submitContactUs: 'Contact us submited successfully',
  alreadyPurchasedClass: "You Had Already Purchased This Keyboard",
  success: "SUCCESS",
  notFound: 'Not Found',
  NOKEYBOARDFOUND: "Unable to find the keyboard.",
  NOTRANSACTIONFOUND: "No transaction found.",
  PAYMENTREJECTED: "Your payment has been rejected, Please contact support.",
  KEYBOARDBOUGHTERROR: "You have already bought the keyboard."
};
const codes = {
  SUCCESS: 200,
  BADREQUEST: 400,
