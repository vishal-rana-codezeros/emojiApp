		...
		return (
			<div>
				<Row>
					<Col xs="12" md="12">
						<Card>
							<CardHeader className="aboutUsCss">About Us</CardHeader>
									...
									<FormGroup row>
										...
										<Col xs="12" md="12">
											<div>
												...
												/>
												{errors.descriptionVal && (
													<em className="has-error">{errors.descriptionVal}</em>
												)}
											</div>
										</Col>
									</FormGroup>
							...
							<CardFooter className="p-12">
								<Row>
									{this.state.id && (
										<Button type="submit" size="sm" color="success" onClick={this.onClickToSave}>
									...
									<Button type="reset" size="sm" color="danger" onClick={this.onReset}>
...
export default connect(
	null,
	{ addAboutusPage, getAboutusPage, updateAboutusPage, LoaderAction, logout }
)(AboutUs);
