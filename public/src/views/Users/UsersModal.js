					...
					docs.map(x =>
						tableData.push([
							...
							<>
								...
								{x.status == 'ACTIVE' && (
									<DeleteConfirmDialog deleteId={x._id} onClick={this.onClickToDelete} />
								)}
								{x.status == 'INACTIVE' && (
									<ActiveConfirmDialog
										activeId={x._id}
										onClick={e => {
											this.onClickToActive(x._id);
										}}
									/>
								)}
							</>,
						...
						<Card className="tablecss">
							...
							<CardBody>
								<Datatable
									...
									onFetchData={this.onChangeToFetchTable.bind(this)}
...
export default connect(
	null,
	{ getAllUser, deleteUser, getOneUser, updateUser, activeUser, LoaderAction }
)(UsersModal);
